...
public partial class ShopDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Product>().HasData(
            ...
            new Product(3, "Portatil HP", "Portatil para escritorio y manejo de office", 900, 2),
            new Product(4, "Portatil Acer", "Portatil para juegos avanzados de memoria", 1200, 2),
            new Product(5, "Mackbook Apple", "Mackbook para transporte de gran capacidad", 1500, 2),
        ...
        modelBuilder.Entity<Client>().HasData(
            ...
            new Client(2, "Maria La Paz", "Calle Nueva Rosa 556"));
    }
}
